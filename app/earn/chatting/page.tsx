...
export default function ChattingPage() {
  ...
  return (
    <main className="bg-gray-50 min-h-screen">
      ...
      {/* WhatsApp FAB */}
      <a href="https://wa.me/254700000000?text=Hi%2C%20I%27d%20like%20to%20apply%20for%20remote%20chatting%20on%20Chat254."
      ...
      {modalOpen && <ApplicationModal onClose={() => setModalOpen(false)} track="Remote Chatting" />}
    </main>
  );
}
