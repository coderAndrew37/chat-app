    ...
    >
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
          ...
          <div>
            ...
            <input id="login-email" type="email" autoComplete="email" placeholder="you@example.com"
              className={`w-full px-4 py-3 rounded-xl border text-sm outline-none transition-colors focus:ring-2 focus:ring-rose-500/20 ${errors.email ? "border-red-400 bg-red-50" : "border-gray-200 focus:border-rose-400"}`}
              {...register("email")} />
          ...
          <div>
            ...
            <input id="login-password" type="password" autoComplete="current-password" placeholder="••••••••"
              className={`w-full px-4 py-3 rounded-xl border text-sm outline-none transition-colors focus:ring-2 focus:ring-rose-500/20 ${errors.password ? "border-red-400 bg-red-50" : "border-gray-200 focus:border-rose-400"}`}
              {...register("password")} />
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <button onClick={onSwitchToRegister} className="text-rose-500 font-semibold hover:underline">
            Join Free
          </button>
        </p>
      </div>
