...
import type { ApplicationFormData } from "./ApplicationModal";
...
// ⚠️  Replace this with your actual WhatsApp business number
...
export default function SuccessState({ data, onClose }: SuccessStateProps) {
  ...
  const message = encodeURIComponent(
    `Hi! My name is ${data.name} and I just applied to join the Chat254 remote team. ` +
